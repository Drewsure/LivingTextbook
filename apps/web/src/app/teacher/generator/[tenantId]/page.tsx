...
import {
  filterAiGenerationRequestToDraftHandoffsByTenant,
...
import {
  filterAiVerifierResultEvidencePacketsByTenant,
    ...
    <AppShell tenant={tenant}>
      <div className="grid gap-5">
        ...
        <AiGenerationRequestToDraftHandoffPanel
          handoffs={filterAiGenerationRequestToDraftHandoffsByTenant(
            sampleAiGenerationRequestToDraftHandoffs,
            tenantId,
          )}
        />
        ...
        <AiVerifierResultEvidencePacketPanel
          packets={filterAiVerifierResultEvidencePacketsByTenant(sampleAiVerifierResultEvidencePackets, tenantId)}
        />
