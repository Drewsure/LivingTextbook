...
const sampleDurableRecordContractsRaw: DurableRecordContract[] = [
  ...
  {
    recordId: "teacher-draft-persistence-implementation-readiness-record",
    category: "teacher-draft-persistence-implementation-readiness",
    label: "Teacher draft persistence implementation readiness record",
    readiness: "policy-required",
    sourceOfTruth: "TeacherDraftPersistenceImplementationReadiness, acceptance tests, provider-neutral storage boundaries, and rollback requirements",
    requiredBeforePilot: false,
    containsStudentData: false,
    containsMediaRights: false,
    supportsLocalDeployment: true,
    ...
    recommendedFirstPilotStore: ["hosted-database", "local-classroom-store"],
    note: "This record makes the implementation-readiness packet durable without selecting a provider or enabling live persistence. It remains review-only until all acceptance tests and policy decisions are approved.",
  },
  {
  ...
  {
    recordId: "ai-generated-package-writer-test-harness-implementation-proposal-record",
    category: "ai-generated-package-writer-test-harness-implementation-proposal",
    label: "AI generated package writer test harness implementation proposal record",
    readiness: "durable-required",
    sourceOfTruth:
      "AiGeneratedPackageWriterTestHarnessImplementationProposal, test harness plan record, test evidence packet record, module test plan record, proposed module scope, implementation boundaries, review gates, dry-run-only checks, next records, and support-language boundary lanes",
    requiredBeforePilot: false,
    containsStudentData: false,
    containsMediaRights: true,
    supportsLocalDeployment: true,
    ...
    recommendedFirstPilotStore: ["hosted-database", "hosted-object-storage", "local-classroom-store"],
    note:
      "AI generated package writer test harness implementation proposals need durable module scope and review-gate boundaries before generated package writer harness code, automated writer tests, mutation browser runs, evidence upload, app file patches, route writes, playlist writes, local bundle packaging, assignment activation, or support-language-only harness passes can exist.",
  },
  {
    recordId: "ai-generated-package-writer-harness-implementation-decision-record",
    category: "ai-generated-package-writer-harness-implementation-decision",
    label: "AI generated package writer harness implementation decision record",
    readiness: "durable-required",
    sourceOfTruth:
      "AiGeneratedPackageWriterHarnessImplementationDecision, harness implementation proposal, test harness plan, evidence packet, decision options, required evidence, file-scope rules, reviewer identity, next records, and support-language boundary lanes",
    requiredBeforePilot: false,
    containsStudentData: false,
    containsMediaRights: true,
    supportsLocalDeployment: true,
  ...
  },
  {
    ...
    readiness: "durable-required",
    sourceOfTruth: "LaunchSession plus TeacherSessionSettings plus TeacherSessionSettingsReviewPacket",
    requiredBeforePilot: true,
    ...
    recommendedFirstPilotStore: ["hosted-database", "local-classroom-store", "school-policy"],
    note: "Teacher microphone approval, assist-language visibility, background media, AI Tutor state, reporting settings, and the settings review packet belong here.",
  },
  {
    ...
    readiness: "policy-required",
    sourceOfTruth: "GameProgressEvent, ProgressEventEnvelope, settings context, media events, recovery metadata, Star Dust changes, mastery updates",
    requiredBeforePilot: true,
    containsStudentData: true,
    containsMediaRights: false,
    supportsLocalDeployment: true,
    ...
    requiresEventAcceptanceGate: true,
    recommendedFirstPilotStore: ["hosted-database", "local-classroom-store", "school-policy"],
    note: "This stream powers reports and recovery, but it must preserve event effect taxonomy and settings context, require a passed event acceptance gate, and have retention/export/access policy before real student storage.",
  },
  {
    recordId: "progression-continuity-record",
    category: "progression-continuity",
    label: "Progression continuity handoff record",
    readiness: "policy-required",
    sourceOfTruth: "ProgressionContinuityEnvelope, route handoff cursor, continuity snapshot, and review-only runtime decision",
    requiredBeforePilot: true,
    containsStudentData: true,
    containsMediaRights: false,
    supportsLocalDeployment: true,
    ...
    recommendedFirstPilotStore: ["hosted-database", "local-classroom-store", "school-policy"],
    note: "Route handoff continuity keeps source/destination identity, cursor, and a compact progression snapshot together. It remains policy-gated and review-only until a backend is selected; raw audio, transcripts, URL state, and live unlock side effects are excluded.",
  },
  {
  ...
  },
  {
    ...
    readiness: "policy-required",
    sourceOfTruth: "TeacherReportPackageBoundary plus TeacherReportExportPlan, event acceptance gate summary, settings context summary, event-effect taxonomy, and school/tenant export policy",
    requiredBeforePilot: true,
    containsStudentData: true,
    containsMediaRights: false,
    supportsLocalDeployment: true,
    ...
    preservesSettingsContext: true,
    recommendedFirstPilotStore: ["school-policy", "hosted-database", "local-classroom-store"],
    note: "Teacher reports need a durable package boundary so event acceptance status, settings context summaries, learning evidence, support-only events, excluded sensitive fields, and export blockers are preserved across hosted and local deployments.",
  },
  {
...
export const samplePersistenceBoundaries: PersistenceBoundary[] = [
  ...
  {
    boundaryId: "ai-generated-package-writer-test-harness-implementation-proposal-boundary",
    category: "ai-generated-package-writer-test-harness-implementation-proposal",
    label: "AI generated package writer test harness implementation proposal records",
    status: "needs-backend",
    recordShape:
      "Implementation proposal id, tenant id, request id, harness plan id, evidence packet id, module test plan id, package id preview, proposed module scope, implementation boundaries, required review gates, dry-run-only checks, next records, blocked actions, and support-language boundary lanes",
    whyItMatters:
      "Generated package writer harness implementation proposals need durable module scope and review gates so a readable proposal cannot become harness code, runnable writer tests, mutation browser checks, evidence uploads, signed approvals, app file patches, route writes, playlist writes, local bundle packaging, assignment activation, or support-language-only harness passes from UI state alone.",
    visibleTo: ["Teacher", "Tenant admin", "Content reviewer", "Platform admin"],
    deploymentChannels: ["hosted-web", "installed-pwa", "desktop-app", "local-classroom-server"],
    nextDecision:
      "Persist AI generated package writer test harness implementation proposals before enabling harness implementation, automated writer test execution, mutation browser runs, evidence upload, signed approval capture, app file patches, generated package JSON writes, route writes, playlist writes, local bundle packaging, assignment activation, or support-language-only harness passes.",
  },
  {
    boundaryId: "ai-generated-package-writer-harness-implementation-decision-boundary",
    category: "ai-generated-package-writer-harness-implementation-decision",
    label: "AI generated package writer harness implementation decision records",
    status: "needs-backend",
    recordShape:
      "Decision id, tenant id, request id, implementation proposal id, harness plan id, evidence packet id, decision state, required evidence, file-scope rules, decision options, blocked actions, next records, reviewer identity, and support-language boundary lanes",
    whyItMatters:
      "Generated package writer harness implementation decisions need durable evidence, file-scope, reviewer identity, and decision-option boundaries so a readable decision preview cannot become harness approval, harness code, runnable writer tests, mutation browser checks, evidence uploads, signed approvals, app file patches, route writes, playlist writes, local bundle packaging, assignment activation, or support-language-only implementation decisions from UI state alone.",
    visibleTo: ["Teacher", "Tenant admin", "Content reviewer", "Platform admin"],
    deploymentChannels: ["hosted-web", "installed-pwa", "desktop-app", "local-classroom-server"],
    nextDecision:
