  ...
  lanes: [
    {
      ...
      evidence: "89 active route checks pass, including MiniStar and sample publisher student, teacher, media, print, assignment, report, deployment, pilot, local companion, and QR resolver routes.",
