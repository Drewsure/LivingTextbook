...
export const sampleActivityPathwayCompatibilityMatrix: ActivityPathwayCompatibilityMatrix = {
  ...
  items: [
    ...
    },
    {
      ...
      compatibilityRule: "Planned for level 2+ units when sentence segmentation is reviewed for the target language; not offered in this level 1 pathway.",
      nextStep: "Promote only in a level 2+ package after segmentation, audio, and progression evidence pass.",
    },
    {
      itemId: "true-false",
      label: "True or False",
    ...
    {
      itemId: "spelling-practice",
      label: "Spelling Practice",
      outputKind: "student-game",
      status: "offered",
      recommendedOrder: 8,
      sourcePayloadFit: "Works for reviewed vocabulary terms where target-language spelling can be represented as deterministic letter tiles.",
      targetLanguageTrigger: "Correct target-language letter order counts; support-language hints and taps remain support-only.",
      audioRequirement: "Prompt word, letter tiles, instructions, feedback, and submit control require audio support.",
      reportingRequirement: "Reports standard text-spelling round, answer, result, completion, and mastery events.",
      compatibilityRule: "Valid when vocabulary spelling and segmentation are reviewed for the target language.",
      nextStep: "Extend segmentation rules before Japanese target-language spelling, dictation, or typing race modes.",
    },
    {
      itemId: "fill-in-the-blank",
      label: "Fill in the Blank",
      outputKind: "student-game",
      status: "offered",
      recommendedOrder: 9,
      sourcePayloadFit: "Uses exactly 2 reviewed target sentence structures with one reviewed vocabulary word or phrase hidden per round.",
      targetLanguageTrigger: "Correct target-language sentence completion counts; support-language glosses and hints remain support-only.",
      audioRequirement: "Full sentence model, blank sentence prompt, choices, feedback, and submit control require audio support.",
      reportingRequirement: "Reports standard text-spelling round, answer, result, completion, and mastery events.",
      compatibilityRule: "Valid when the missing word or phrase comes from reviewed vocabulary or reviewed sentence segmentation.",
      nextStep: "Use as the simpler syntax route before Sentence Builder, ordering, or premium animated syntax skins.",
    },
    {
      itemId: "speak-it",
