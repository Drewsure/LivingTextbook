  ...
  },
  {
    ...
    gates: [
      ...
      },
      {
        ...
        status: "pass",
        owner: "platform",
        note: "The front-door pilot draft has audio-covered assignment metadata for Flashcards, Match Up, Memory Match, Balloon Pop, Quiz, True or False, Sentence Builder, and Speak It.",
      },
      {
