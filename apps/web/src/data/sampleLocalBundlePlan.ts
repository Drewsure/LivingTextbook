...
export const sampleLocalBundleManifests: LocalBundleManifestSummary[] = [
  {
    ...
    games: [
      ...
      {
        gameId: "ministar-local-label-it",
        label: "Label It",
        gameMode: "label-it",
        engineId: "pairing",
        localPath: "/label-it/demo-unit-1",
        status: "planned",
        audioCovered: true,
        reportsProgress: true,
        note: "Image-label route can ship only with reviewed anchor records and rights-safe assets.",
      },
      {
  ...
  },
  {
    ...
    games: [
      ...
      {
        gameId: "partner-local-label-it",
        label: "Label It",
        gameMode: "label-it",
        engineId: "pairing",
        localPath: "/label-it/partner-demo-unit-1",
        status: "planned",
        audioCovered: true,
        reportsProgress: true,
        note: "Image-label route remains planned until reviewed image manifests and label anchors are packaged.",
      },
      {
