...
export const sampleBackendMigrationPlan: BackendMigrationPlan = {
  ...
  candidates: [
    ...
    },
    {
      ...
      rollbackOrExportNeeds: ["Export session settings snapshot", "Archive expired sessions", "Keep policy and settings revision snapshots for report interpretation"],
      notAllowedYet: ["Ungated AI Tutor", "Speech scoring without premium policy", "Support-language mastery credit", "Background media unlock credit", "Raw audio or transcripts in launch settings"],
    },
    {
  ...
  standingRules: [
    ...
    "Launch-session migrations must preserve teacher settings snapshots before accepting student events.",
