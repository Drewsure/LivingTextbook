...
export const sampleBackendMigrationPlan: BackendMigrationPlan = {
  ...
  candidates: [
    ...
    },
    {
      ...
      purpose: "Persist reviewed package releases, edition/version metadata, and active release state without making raw source files student-facing.",
      ...
      rollbackOrExportNeeds: ["Export package release metadata", "Retain archived release target for old QR routes"],
