...
export const sampleAiGeneratedPackageTeacherReviewPackets: AiGeneratedPackageTeacherReviewPacket[] = [
  {
    ...
    decisionLanes: [
      ...
      },
      {
        ...
        evidence: "Flashcards, Match Up, Memory Match, Quiz, Sentence Builder, Speak It, and printable review are curated.",
  ...
  },
  {
    ...
    decisionLanes: [
      ...
      },
      {
        ...
        status: "accepted-preview",
        sourceRecord: "activity_compatibility_snapshot",
        evidence: "Entry Flashcards, Match Up, Memory Match, Quiz, Sentence Builder, Speak It, and printable review are curated.",
