...
export const sampleAiGeneratedPackageTeacherReviewPackets: AiGeneratedPackageTeacherReviewPacket[] = [
  {
    ...
    decisionLanes: [
      ...
      },
      {
        ...
        evidence: "Flashcards, Memory Match, Quiz, Sentence Builder, Speak It, and printable review are curated.",
  ...
  },
  {
    ...
    decisionLanes: [
      ...
      },
      {
        ...
        status: "accepted-preview",
        sourceRecord: "activity_compatibility_snapshot",
        evidence: "Entry Flashcards, Memory Match, Quiz, Sentence Builder, Speak It, and printable review are curated.",
