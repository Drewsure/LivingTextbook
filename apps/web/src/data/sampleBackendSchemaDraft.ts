...
export const sampleBackendSchemaDraft: BackendSchemaDraft = {
  ...
  entities: [
    ...
    },
    {
      ...
      migrationNote: "Policy and role access are required before live classroom storage. The settings snapshot and event acceptance gate must preserve non-scoring support-language, background-media, and route-guidance flags.",
    },
    {
  ...
  crossCuttingRules: [
    ...
    "Launch sessions must preserve teacher settings snapshots and event acceptance gates so support-language, microphone, background-media, AI Tutor, Training Academy, reporting, and live-event-write controls are auditable.",
