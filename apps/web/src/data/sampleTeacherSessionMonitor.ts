...
import type {
  ...
  TeacherSessionEventAcceptanceItem,
...
function createSampleMonitorEvents(launchSession: LaunchSession, isPartner: boolean): GameProgressEvent[] {
  ...
  return [
    ...
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:14:40.000Z",
      metadata: {
        parentEngine: "selection",
        scoringProfileId: "selection-assessment-v1",
      },
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:14:55.000Z",
      metadata: {
        completed: true,
        earnedStarDust: 225,
        completedRounds: 6,
    ...
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:14:58.000Z",
      metadata: {
    ...
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:14:59.000Z",
      metadata: {
        completed: true,
        earnedStarDust: 250,
        completedRounds: 6,
    ...
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:16:00.000Z",
      metadata: {
        tenantId: launchSession.tenantId,
        parentEngine: "pairing",
        replaySeed: `replay-v1:${unitKey}:memory-match:retry-2`,
        scoringProfileId: "pairing-vocabulary-v1",
      },
    },
    {
      type: "round_shown",
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:16:01.000Z",
      metadata: {
        tenantId: launchSession.tenantId,
        replaySeed: `replay-v1:${unitKey}:memory-match:retry-2`,
        roundId: "memory-match-retry-2-round-1",
      },
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:16:03.000Z",
      metadata: {
        tenantId: launchSession.tenantId,
        replaySeed: `replay-v1:${unitKey}:memory-match:retry-2`,
        targetLanguageAttempt: true,
    ...
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:16:04.000Z",
      metadata: {
        tenantId: launchSession.tenantId,
        replaySeed: `replay-v1:${unitKey}:memory-match:retry-2`,
        correct: true,
    ...
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:16:05.000Z",
      metadata: {
        tenantId: launchSession.tenantId,
        replaySeed: `replay-v1:${unitKey}:memory-match:retry-2`,
        cueKind: "feedback",
        cueText: isPartner ? "Good job." : "Great job.",
        language: "en",
        progressionUnlockAllowed: false,
        masteryCreditAllowed: false,
        starDustAwarded: 0,
    ...
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:16:06.000Z",
      metadata: {
        tenantId: launchSession.tenantId,
        replaySeed: `replay-v1:${unitKey}:memory-match:retry-2`,
        completed: true,
    ...
    },
    {
      ...
      launchCode,
      studentSessionId,
      occurredAt: "2026-07-01T00:16:07.000Z",
      metadata: {
        tenantId: launchSession.tenantId,
        replaySeed: `replay-v1:${unitKey}:memory-match:retry-2`,
        earnedStarDust: 325,
