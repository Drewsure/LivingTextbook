...
function createMonitorProgression(
  ...
  return {
    ...
    unlockedGameModes: uniqueModes([...progression.unlockedGameModes, ...launchSession.recommendedNextModes, "quiz", "true-false", "sentence-builder", "speak-it"]),
    completedGameModes: uniqueModes([...progression.completedGameModes, launchSession.entryMode, "memory-match", "quiz", "true-false", "sentence-builder"]),
    earnedStarDust: 1000,
