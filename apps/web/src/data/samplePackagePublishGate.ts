...
export const samplePackagePublishGate: PackagePublishGate = {
  ...
  items: [
    ...
    },
    {
      ...
      owner: "shared",
      blocksRelease: true,
      evidence: "Flashcards, Match Up, Label It, Memory Match, Balloon Pop, Speak It, Training Academy, and prototype assignment contracts exist, but the final pilot game set must be approved per unit.",
