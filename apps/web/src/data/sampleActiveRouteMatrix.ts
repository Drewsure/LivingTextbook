...
export const sampleActiveRouteMatrix: ActiveRouteMatrixItem[] = [
  ...
  },
  {
    ...
    path: "/flashcards/demo-unit-1",
    status: "active-scaffold",
    note: "Direct entry-practice route with target-language audio gating before recommended games unlock.",
  },
  {
  ...
  },
  {
    ...
    path: "/balloon/demo-unit-1",
    status: "active-scaffold",
    note: "Arcade selection-engine vocabulary reinforcement route with tap-to-speak prompts.",
  },
  {
  ...
  },
  {
    ...
    group: "sample-publisher",
    label: "Sample publisher flashcards",
    path: "/flashcards/partner-demo-unit-1",
    status: "active-scaffold",
    note: "White-label direct entry-practice route with target-language audio gating before recommended games unlock.",
  },
  {
  ...
  },
  {
    ...
    group: "sample-publisher",
    label: "Sample publisher balloon pop",
    path: "/balloon/partner-demo-unit-1",
    status: "active-scaffold",
    note: "White-label arcade selection-engine vocabulary reinforcement route with tap-to-speak prompts.",
  },
  {
