...
export const sampleAiGeneratorReviewSummaries: AiGeneratorReviewSummary[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        status: "blocked",
        summary: "Verifier, manifest, promotion, publish readiness, and release-candidate previews exist but cannot become student routes.",
        primaryBlocker: "Verifier approval, media rights, teacher approval, and release-control records are incomplete.",
        nextRequiredRecord: "ai_verifier_submission_packet",
        blockedActions: ["No package assembly", "No route creation", "No playlist creation", "No student assignment"],
        sourceRecords: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        label: "Package review",
        status: "blocked",
        summary: "MiniStar verifier, manifest, promotion, publish readiness, and release-candidate records are blocked from student release.",
        primaryBlocker: "MiniStar media rights, teacher approval, and release-control binding are incomplete.",
        nextRequiredRecord: "MiniStar media rights manifest",
        blockedActions: ["No package assembly", "No playlist creation", "No student assignment", "No Japanese support-language release"],
        sourceRecords: [
          "ai_verifier_submission_packet",
          "ai_generated_package_manifest",
          "ai_generated_publish_readiness_gate",
