...
const sampleInstructionAudioCues: AudioCue[] = [
  ...
  {
    audioCueId: "cue-ministar-l1-u1-instruction-fill-in-the-blank",
    tenantId: levelOneUnitOne.unitMeta.tenantId,
    kind: "instruction",
    text: "Listen to the sentence. Choose the missing greeting word.",
    language: "en",
    source: "text-to-speech",
    transcript: "Listen to the sentence. Choose the missing greeting word.",
    unitKey: sampleUnitKey,
...
const sampleFeedbackAudioCues: AudioCue[] = [
  ...
  {
    audioCueId: "cue-ministar-l1-u1-feedback-fill-in-correct",
    tenantId: levelOneUnitOne.unitMeta.tenantId,
    kind: "feedback",
  ...
  audioSupportPlans: [
    {
      ...
      gameModeAudioCueIds: {
        ...
        "fill-in-the-blank": [
          ...sampleSentenceAudioCues.map((cue) => cue.audioCueId),
          "cue-ministar-l1-u1-instruction-fill-in-the-blank",
          "cue-ministar-l1-u1-feedback-fill-in-correct",
        ],
        "balloon-pop": [
          ...sampleVocabularyAudioCues.map((cue) => cue.audioCueId),
