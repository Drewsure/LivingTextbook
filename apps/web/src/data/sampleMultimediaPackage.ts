...
const sampleInstructionAudioCues: AudioCue[] = [
  ...
  {
    audioCueId: "cue-ministar-l1-u1-instruction-label-it",
    tenantId: levelOneUnitOne.unitMeta.tenantId,
    kind: "instruction",
    text: "Tap a label. Then tap the matching picture point.",
    language: "en",
    source: "text-to-speech",
    transcript: "Tap a label. Then tap the matching picture point.",
    unitKey: sampleUnitKey,
    gameMode: "label-it",
    textbookReference: sampleTextbookReference,
  },
  ...
  {
    audioCueId: "cue-ministar-l1-u1-instruction-type-answer",
    tenantId: levelOneUnitOne.unitMeta.tenantId,
    kind: "instruction",
    text: "Listen to the word. Type the greeting answer.",
    language: "en",
    source: "text-to-speech",
    transcript: "Listen to the word. Type the greeting answer.",
    unitKey: sampleUnitKey,
    gameMode: "type-answer",
    textbookReference: sampleTextbookReference,
  },
  {
    audioCueId: "cue-ministar-l1-u1-instruction-spelling-practice",
    tenantId: levelOneUnitOne.unitMeta.tenantId,
    kind: "instruction",
    text: "Listen to the word. Tap the greeting letters in order.",
    language: "en",
    source: "text-to-speech",
    transcript: "Listen to the word. Tap the greeting letters in order.",
    unitKey: sampleUnitKey,
...
const sampleFeedbackAudioCues: AudioCue[] = [
  ...
  {
    audioCueId: "cue-ministar-l1-u1-feedback-label-it-correct",
    tenantId: levelOneUnitOne.unitMeta.tenantId,
    kind: "feedback",
    text: "Correct label. Choose another one.",
    language: "en",
    source: "text-to-speech",
    transcript: "Correct label. Choose another one.",
    unitKey: sampleUnitKey,
    gameMode: "label-it",
    textbookReference: sampleTextbookReference,
  },
  ...
  {
    audioCueId: "cue-ministar-l1-u1-feedback-type-answer-correct",
    tenantId: levelOneUnitOne.unitMeta.tenantId,
    kind: "feedback",
  ...
  {
    audioCueId: "cue-ministar-l1-u1-feedback-spelling-correct",
    tenantId: levelOneUnitOne.unitMeta.tenantId,
    kind: "feedback",
  ...
  audioSupportPlans: [
    {
      ...
      gameModeAudioCueIds: {
        ...
        "label-it": [
          ...sampleVocabularyAudioCues.map((cue) => cue.audioCueId),
          "cue-ministar-l1-u1-instruction-label-it",
          "cue-ministar-l1-u1-feedback-label-it-correct",
        ],
        quiz: [
          ...sampleVocabularyAudioCues.map((cue) => cue.audioCueId),
          ...sampleSentenceAudioCues.map((cue) => cue.audioCueId),
        ...
        "type-answer": [
          ...sampleVocabularyAudioCues.map((cue) => cue.audioCueId),
          "cue-ministar-l1-u1-instruction-type-answer",
          "cue-ministar-l1-u1-feedback-type-answer-correct",
        ],
        "spelling-practice": [
          ...sampleVocabularyAudioCues.map((cue) => cue.audioCueId),
          "cue-ministar-l1-u1-instruction-spelling-practice",
          "cue-ministar-l1-u1-feedback-spelling-correct",
        ],
        "balloon-pop": [
          ...sampleVocabularyAudioCues.map((cue) => cue.audioCueId),
