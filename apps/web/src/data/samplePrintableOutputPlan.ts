...
export const samplePrintableOutputPlan: PrintableOutputPlan = {
  ...
  exportDecision: "PDF export blocked. Browser-print previews are available for the first vocabulary and sentence sheets, but no printable should be formally handed off until QR/audio, rights, versioning, and teacher export gates are closed.",
  outputs: [
    {
      ...
      routeBridge: "/print/partner-demo-unit-1 and /launch/partner-demo-unit-1.",
      reportingBoundary: "No automatic Star Dust or mastery unless opened through an assignment QR route.",
      blocker: "PDF export, QR placement, and durable rights/version snapshots are not implemented.",
      nextStep: "Add QR placement and version snapshot before formal teacher handoff.",
    },
    {
      ...
      routeBridge: "/print/partner-demo-unit-1 and /sentence/partner-demo-unit-1.",
      reportingBoundary: "Paper practice remains teacher-marked unless a digital assignment route is used.",
      blocker: "PDF export, QR placement, and teacher-marking workflow are not built.",
      nextStep: "Define tracing, fill-in, and answer-key variants after browser-print preview is reviewed.",
    },
    {
  ...
  gates: [
    ...
    },
    {
      ...
      status: "ready",
      evidence: "Basic browser-print preview exists at /print/demo-unit-1 and /print/partner-demo-unit-1.",
      blocksExport: false,
      nextStep: "Keep PDF export blocked until QR/audio, version/rights, and export-policy gates pass.",
    },
    {
