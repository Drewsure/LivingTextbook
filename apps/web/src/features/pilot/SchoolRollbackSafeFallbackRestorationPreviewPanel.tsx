  ...
  return (
    <Card>
      ...
      <section className="mt-5 rounded-lg border border-[var(--tenant-border)] bg-[var(--tenant-primary-soft)] p-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="text-xs font-semibold uppercase text-[var(--tenant-muted)]">Release-control evidence inherited from activation preview</p>
            ...
            <p className="mt-2 text-sm leading-6 text-[var(--tenant-muted)]">
              ...
              Restoration remains evidence-only and cannot override release-control policy.
            </p>
          </div>
          <StatusPill label="Not restored" tone="neutral" />
        </div>
