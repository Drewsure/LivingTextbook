...
} from "@/data/samplePrototypeIntakeReadinessSummary";

interface PrototypeIntakeReadinessSummaryPanelProps {
  summary: PrototypeIntakeReadinessSummary;
}

const statusLabel: Record<PrototypeIntakeReadinessStatus, string> = {
  "not-ready": "Not ready",
  "evidence-review-needed": "Evidence review needed",
  "ready-for-codex-alert": "Ready for Codex alert",
};

const laneTone: Record<PrototypeIntakeReadinessLane["status"], "success" | "warning"> = {
  ready: "success",
  missing: "warning",
  blocked: "warning",
};
  ...
  return (
    <Card>
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <p className="text-sm font-semibold text-[var(--tenant-muted)]">Prototype intake readiness</p>
      ...
      <section className="mt-5 rounded-lg border border-[var(--tenant-border)] p-4">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <h3 className="text-base font-bold text-[var(--tenant-text)]">Blocked next actions</h3>
