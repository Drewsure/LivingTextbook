  ...
  return (
    <div className="mx-auto grid max-w-3xl gap-5">
      <GameRouteHeaderCard
        ...
        summary="Listen to reviewed target-language vocabulary and build the spelling from letter tiles. This extends the text-spelling parent engine without adding a one-off game or random reward path."
      ...
      <UnitSessionProgressSummary
        title="Spelling Practice Progress"
        launchSession={launchSession}
