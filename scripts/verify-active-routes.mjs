...
if (teacherIntakeExpected) {
  ...
  if (routeCountIndex >= 0) {
    teacherIntakeExpected[routeCountIndex] = "80 checked routes";
  }
...
const warmupPaths = ["/", "/teacher", "/teacher/intake", "/teacher/persistence", "/teacher/session-settings", "/teacher/game-readiness"];
