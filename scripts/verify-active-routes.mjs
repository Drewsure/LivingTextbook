...
const expectedTextByPath = new Map([
  ...
  ["/teacher/authoring/draft-sample-publisher-l1-u1", ["Teacher draft package", "Draft only", "Student assignment blocked", "Review before assignment", "Audio before students", "Private tenant library candidate", "No direct publish"]],
