...
const expectedTextByPath = new Map([
  ...
  ["/teacher/sessions/demo-unit-1", ["Session pilot readiness", "Report package boundary", "Media engagement", "Settings snapshot", "tap-to-speak learning audio"]],
  ["/teacher/sessions/partner-demo-unit-1", ["Session pilot readiness", "Report package boundary", "Media engagement", "Settings snapshot", "tap-to-speak learning audio"]],
