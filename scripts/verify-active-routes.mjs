...
const expectedTextByPath = new Map([
  ...
  ["/collection/demo-unit-1", ["Earned collection", "Collection room preview", "Mastery unlocks only", "No random rewards"]],
  ["/collection/partner-demo-unit-1", ["Earned collection", "Collection room preview", "Mastery unlocks only", "No random rewards"]],
