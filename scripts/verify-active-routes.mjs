...
const expectedTextByPath = new Map([
  ["/teacher/intake", ["Package publish gate", "Pilot source strategy", "Pilot release candidate", "Backend selection gate", "Background media policy", "Maintenance change queue"]],
