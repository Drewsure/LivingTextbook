...
const expectedTextByPath = new Map([
  ...
  ["/teacher/release-readiness", ["White-label release control", "One readiness view for every publisher tenant", "Production approval blocked", "Student launch blocked", "Foundation hardening", "Canonical game integration", "Production persistence and deployment", "Required quality signals", "Evidence checks are separate from approval", "Evidence: ", "Package evidence reconciliation", "Lane-level evidence controls this release view", "Unresolved package lanes", "Controlled pilot decision", "Pilot evidence is bound to the same tenant package", "Pilot blockers", "No production approval", "No provider activation", "Browser evidence adjudication", "Awaiting observation"]],
  ...
  ["/teacher/deployment", ["Deployment decision workbench", "Hosted PWA, local classroom server, and packaged companion decisions", "Review-only", "No offline-ready claim", "No local package activation", "Cost controlled", "Standing deployment gate", "Deployment decision guide", "Hosted PWA first pilot", "Local classroom server pilot", "Packaged textbook companion", "Lowest initial support cost", "Moderate support cost", "Highest support cost", "Required evidence", "Blocked actions", "No report export", "No real learner data collection", "No student-facing paid feature prompt", "No media-only progress", "No support-language-only progression", "Deployment profiles", "Hosted, local, and packaged paths", "PWA and offline readiness", "Media bundle integrity readiness", "Local deployment preflight", "Local bundle manifests", "Closed textbook companion package shape", "White-label package catalog", "Base platform first, optional packages second", "Core classroom PWA", "Enterprise storage and local companion", "Deployment continuity decision", "Deployment choice and recovery evidence must agree", "No option selected", "No side effect", "Hosted PWA", "Local classroom server", "Packaged textbook companion", "Continuity evidence ready: false", "No provider selection", "No persistence activation", "No classroom launch", "No offline-ready claim", "No installer or route mutation", "Commercial deployment handoff", "Three product paths, one review packet", "No export", "No activation", "No installation", "No QR or route mutation", "Hosted PWA review packet", "Local classroom server review packet", "Packaged textbook companion review packet", "Handoff blockers", "/teacher/intake", "/teacher/persistence", "/teacher/entitlements", "/local/sample-publisher", "/local/ministar"]],
  ["/teacher/persistence", ["Persistence readiness workbench", "Backend and local storage without vendor lock-in", "Review-only", "No backend vendor selection", "No live storage writes", "Cost control", "hosted/local parity", "No raw microphone audio", "no transcript storage in the core tier", "Report snapshot recovery rehearsal", "Hosted and closed-local evidence use one shape", "No provider activation", "Required before live recovery", "Backend decision matrix", "First pilot backend decision matrix", "Backend selection gate", "Implementation handoff packet", "Provider-neutral implementation handoff", "Provider unselected", "Writes blocked", "Required category coverage", "Evidence storage adapter selection gate", "Storage adapter selection blocked", "Hosted managed evidence storage candidate", "Closed local evidence store candidate", "Hybrid archive evidence store candidate", "No storage adapter selected", "No object bucket creation", "No signed URL generation", "No attachment migration", "Backend schema draft", "First pilot backend migration candidates", "Backend migration specifications", "Persistence boundary", "Persistence adapter readiness", "How storage stays replaceable", "Durable opt-in", "Write approval", "Cross-deployment recovery rehearsal", "One continuity contract for hosted, local, and hybrid deployments", "Provider unselected", "No side effect", "hosted-managed", "local-classroom", "hybrid", "Provider selection committed: false", "Backup / restore / export rehearsal: required", "Tenant isolation: required", "Raw learner audio and transcripts: excluded", "Rehearsal boundary", "No provider selection", "No persistence writes", "No recovery execution", "No export", "No package promotion", "No route mutation", "Storage preflight", "Storage gate", "/teacher/intake", "/teacher/game-readiness", "/teacher/release-control/sample-publisher", "/local/sample-publisher"]],
  ...
  ["/teacher/release-control/sample-publisher", ["Release-control route workspace", "Pilot release decision room", "No live publish workflow", "Release source routes", "Review source evidence without publishing", "Blocked release actions", "No publish button", "No release-state mutation", "No assignment activation", "No local bundle release", "No student-ready marker", "No support-language-only release", "Pilot release candidate", "Package publish gate", "Package approval ledger", "Do not publish yet", "Required approvals still open", "Release-blocking gates", "Composite evidence release binding", "Pilot evidence is reconciled into release review", "Evidence packet", "Adjudication", "Production approval", "Approval identity readiness", "Required before signed approval capture can exist", "Signed approval capture blocked", "No approve button", "Controlled-pilot approval readiness", "Human review eligibility is separate from approval", "Storage policy boundary", "Storage review is required before human approval design", "Storage selection blocked", "Storage policy carried into pilot decision", "Approval capture blocked", "Release mutation blocked", "Controlled-pilot human review packet", "Signed approval captured: No", "Packet freeze blocked"]],
  ["/teacher/uploads/sample-publisher", ["Teacher upload workspace", "Read-only upload command center", "No live file picker", "No uploaded file becomes student-facing", "No automatic PDF-to-game publish", "Upload intake control preview", "No file input element", "Select file blocked", "Create intake record blocked", "Upload channel readiness", "Upload file policy profiles", "upload_file_policy_profile", "File type and size policy", "Accepted MIME types", "scan_and_file_policy_packet", "No upload promotion without file policy acceptance", "Upload target mapping preview", "Source-to-target mapping", "target_mapping_packet", "No upload-to-assignment shortcut", "Upload review queue", "Upload promotion readiness", "Labelled Diagram asset readiness", "Multimedia asset readiness", "Evidence packet flow", "Upload evidence packet flow", "source_lineage_packet", "rights_proof_packet", "Evidence admission preview", "Evidence completeness is not publication", "evidence-ready", "No live upload button", "No assignment route from uploaded file"]],
  ...
  ["/local/ministar", ["Local companion package preview", "Closed local companion", "MiniStar English Lab", "ministar-level-1-unit-1-demo", "Report snapshot recovery rehearsal", "Hosted and closed-local evidence use one shape", "Required before live recovery", "Local release gate", "Package artifact map", "Package handoff checklist", "Generated manifest snapshot", "Bundled game routes", "Local deployment preflight", "activity-hub", "/activities/demo-unit-1", "/flashcards/demo-unit-1", "/match/demo-unit-1", "/label-it/demo-unit-1", "/memory/demo-unit-1", "/quiz/demo-unit-1", "/true-false/demo-unit-1", "/balloon/demo-unit-1", "/type-answer/demo-unit-1", "/spelling/demo-unit-1", "/fill/demo-unit-1", "/sentence/demo-unit-1", "/speak/demo-unit-1"]],
  ["/local/sample-publisher", ["Local companion package preview", "Closed local companion", "Report snapshot recovery rehearsal", "Hosted and closed-local evidence use one shape", "Required before live recovery", "Local release gate", "Package artifact map", "Package handoff checklist", "Generated manifest snapshot", "Bundled game routes", "Local deployment preflight", "activity-hub", "/activities/partner-demo-unit-1", "/flashcards/partner-demo-unit-1", "/match/partner-demo-unit-1", "/label-it/partner-demo-unit-1", "/memory/partner-demo-unit-1", "/quiz/partner-demo-unit-1", "/true-false/partner-demo-unit-1", "/balloon/partner-demo-unit-1", "/type-answer/partner-demo-unit-1", "/spelling/partner-demo-unit-1", "/fill/partner-demo-unit-1", "/sentence/partner-demo-unit-1", "/speak/partner-demo-unit-1"]],
  ...
  ["/label-it/demo-unit-1", ["Core image-label slice", "Label It:", "Greetings", "Pairing", "Label It Progress", "This activity is locked", "Complete entry practice first", "Target-language practice unlocks the next activity."]],
  ["/label-it/partner-demo-unit-1", ["Core image-label slice", "Label It:", "Daily Routines", "Pairing", "Label It Progress", "This activity is locked", "Complete entry practice first", "Target-language practice unlocks the next activity."]],
  ...
  ["/quiz/demo-unit-1", ["Core selection slice", "Quiz:", "Greetings", "Selection", "Quiz Progress", "This activity is locked", "Complete entry practice first", "Target-language practice unlocks the next activity."]],
  ["/quiz/partner-demo-unit-1", ["Core selection slice", "Quiz:", "Daily Routines", "Selection", "Quiz Progress", "This activity is locked", "Complete entry practice first", "Target-language practice unlocks the next activity."]],
  ...
  ["/teacher/sessions/demo-unit-1/report-package", ["Session launch gate boundary", "Teacher report persistence rehearsal", "Three-layer contract alignment", "No side effect", "Live export blocked", "No live classroom launch", "Real learner data blocked", "Report export still blocked", "Report package preview", "Report snapshot recovery rehearsal", "Hosted and closed-local evidence use one shape", "Required before live recovery", "Export blocked", "Event acceptance summary", "Report settings context", "Settings context summary", "settings_context", "game_mode_settings_profile_id", "teacher_game_mode_settings_snapshot_id", "target-language-only", "support_language_progress_allowed: false", "media_only_progress_allowed: false", "scoring_profile_override_allowed: false", "report-only settings context", "Settings profile", "Support-only signals", "audio_requested", "Learning audio request recorded as support-only"]],
  ["/teacher/sessions/partner-demo-unit-1/report-package", ["Session launch gate boundary", "Teacher report persistence rehearsal", "Three-layer contract alignment", "No side effect", "Live export blocked", "No live classroom launch", "Real learner data blocked", "Report export still blocked", "Report package preview", "Report snapshot recovery rehearsal", "Hosted and closed-local evidence use one shape", "Required before live recovery", "Export blocked", "Event acceptance summary", "Report settings context", "Settings context summary", "settings_context", "game_mode_settings_profile_id", "teacher_game_mode_settings_snapshot_id", "target-language-only", "support_language_progress_allowed: false", "media_only_progress_allowed: false", "scoring_profile_override_allowed: false", "report-only settings context", "Settings profile", "Support-only signals", "audio_requested", "Learning audio request recorded as support-only"]],
...
expectedTextByPath.set("/teacher/pilot", [
  ...
  "Canonical teacher review decision",
  "Demo allowed, pilot launch blocked",
  "Observation-to-pilot decision binding",
  "Pilot review sees the same evidence decision",
  "Pilot launch",
  "Blocking reasons",
  "Required next steps",
  "No live action",
  ...
  "Choose the pilot posture before enabling storage",
  "Selection required",
  "No activation",
  "Not selected",
  "Current effects",
  ...
  "requested evidence, school decisions, demo links, and blockers",
  "No packet export",
...
expectedTextByPath.set("/teacher/game-readiness", [
  ...
  "Return review state is derived from evidence lanes",
...
if (teacherIntakeExpected) {
  ...
  teacherIntakeExpected.push(
    ...
    "Backend adapter gated, not production-active",
...
expectedTextByPath.get("/teacher/evidence/sample-publisher/handoff")?.push(
  ...
  "checksum captured",
  "Attachment-to-storage reconciliation",
  "Every attachment has a storage policy gate, not a storage destination",
