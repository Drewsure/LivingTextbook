...
const expectedTextByPath = new Map([
  ...
  ["/teacher/launch-gate/starter-english-level-1-unit-1-2026.1-pilot-candidate-classroom-launch-gate", ["Classroom launch gate route workspace", "Final pre-launch review", "No live classroom launch", "Launch gate source routes", "Review the evidence sources without starting a class", "Teacher intake source", "Teacher dry-run source", "Partner session report preview", "Partner launch demo route", "Classroom launch gate preview", "Open launch gate workspace", "Launch blocked", "No live student session", "No launch button", "Dry-run evidence required", "Policy and persistence required", "Real learner data blocked", "Report export still blocked"]],
