...
const expectedTextByPath = new Map([
  ...
  ["/teacher/review", ["Teacher draft review queue", "Review workbench preview", "Review handoff packet", "Verifier submission blocked", "Package approval blocked", "Student assignment blocked", "Schema validation packet", "Audio coverage packet", "Rights and version packet", "Route and activity packet", "Approval packet", "No direct AI publish", "No live approval", "Durable handoff storage required", "Reviewer decision preview", "Decision actions disabled", "Return for edits", "Needs audio", "Ready for approval", "Approval still blocked", "Approver identity required", "Review evidence packet preview", "Evidence upload blocked", "Reviewer identity evidence", "Evidence storage required", "No file upload in foundation preview"]],
