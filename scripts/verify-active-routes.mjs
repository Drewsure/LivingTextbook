...
const expectedTextByPath = new Map([
  ...
  ["/local/sample-publisher", ["Local companion package preview", "Closed local companion", "Local release gate", "Package handoff checklist", "Generated manifest snapshot", "Bundled game routes", "Local deployment preflight"]],
  ...
  ["/teacher/sessions/partner-demo-unit-1", ["Session pilot readiness", "Report package boundary", "Media engagement", "tap-to-speak learning audio"]],
  ["/teacher/sessions/demo-unit-1/report-package", ["Report package preview", "Export blocked", "Support-only signals"]],
  ["/teacher/sessions/partner-demo-unit-1/report-package", ["Report package preview", "Export blocked", "Support-only signals"]],
