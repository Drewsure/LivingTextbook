...
const expectedTextByPath = new Map([
  ...
  ["/teacher/deployment", ["Deployment decision workbench", "Hosted PWA, local classroom server, and packaged companion decisions", "Review-only", "No offline-ready claim", "No local package activation", "Cost controlled", "Standing deployment gate", "Deployment decision guide", "Hosted PWA first pilot", "Local classroom server pilot", "Packaged textbook companion", "Lowest initial support cost", "Moderate support cost", "Highest support cost", "Required evidence", "Blocked actions", "No report export", "No real learner data collection", "No student-facing paid feature prompt", "No media-only progress", "No support-language-only progression", "Deployment profiles", "Hosted, local, and packaged paths", "PWA and offline readiness", "Media bundle integrity readiness", "Local deployment preflight", "Local bundle manifests", "Closed textbook companion package shape", "White-label package catalog", "Base platform first, optional packages second", "Core classroom PWA", "Enterprise storage and local companion", "/teacher/intake", "/teacher/persistence", "/teacher/entitlements", "/local/sample-publisher", "/local/ministar"]],
