...
const expectedTextByPath = new Map([
  ...
  ["/label-it/demo-unit-1", ["Core image-label slice", "Label It:", "Greetings", "Pairing", "Label It Progress", "No live upload"]],
  ["/label-it/partner-demo-unit-1", ["Core image-label slice", "Label It:", "Daily Routines", "Pairing", "Label It Progress", "No live upload"]],
  ...
  ["/spelling/demo-unit-1", ["Core spelling slice", "Spelling Practice:", "Greetings", "Text-spelling", "Spelling Practice Progress", "Tap the greeting letters in order."]],
  ["/spelling/partner-demo-unit-1", ["Core spelling slice", "Spelling Practice:", "Daily Routines", "Text-spelling", "Spelling Practice Progress", "Tap the routine letters in order."]],
