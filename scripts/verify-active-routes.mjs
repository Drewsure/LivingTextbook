...
const expectedTextByPath = new Map([
  ...
  ["/teacher/authoring/draft-sample-publisher-l1-u1", ["Teacher draft package", "Draft only", "Local edit preview", "Draft audio coverage preview", "Term audio", "Sentence audio", "Instruction audio", "Save draft blocked", "Submit for review blocked", "Student assignment blocked", "Audio regeneration required", "Review before assignment", "Audio before students", "Private tenant library candidate", "No direct publish"]],
