...
const expectedTextByPath = new Map([
  ...
  ["/teacher/release-readiness", ["White-label release control", "One readiness view for every publisher tenant", "Production approval blocked", "Student launch blocked", "Foundation hardening", "Canonical game integration", "Production persistence and deployment", "No production approval", "No provider activation"]],
