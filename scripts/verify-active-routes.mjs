...
const expectedTextByPath = new Map([
  ...
  ["/teacher/entitlements", ["Package entitlement workbench", "Optional paid features, cost gates, and tenant controls", "Review-only", "No live model billing", "No child-facing upsell", "No package activation", "Core classroom package", "Premium AI generation", "Voice Tutor and speech scoring", "Hosted storage and local companion", "Premium features stay adult-controlled", "No premium upsell shown to children", "No speech API billing", "No storage surprise", "No support-language loophole", "AI generator cost and entitlement gate", "Premium package required", "Tenant AI generation entitlement", "Usage budget ceiling", "Model rate card snapshot", "Voice generation separate package", "AI Tutor separate package", "Enable AI generation blocked", "Estimate API cost blocked", "Premium speech layer", "Voice Tutor", "AI Tutor is an optional premium package and is currently disabled.", "No microphone permission prompt", "No raw audio storage", "No transcript storage", "No report export from this route", "No object storage write", "No local folder write", "No release-state mutation", "No child-triggered cost", "No teacher self-enable", "No direct AI publish", "No live workflow", "/teacher/session-settings", "/teacher/reporting", "/teacher/persistence", "/teacher/generator/sample-publisher", "/teacher/game-readiness"]],
