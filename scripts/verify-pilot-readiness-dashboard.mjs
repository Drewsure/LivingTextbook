...
requireText(readinessSummary, "sampleLocalBundleMediaReleaseControlBinding", "Pilot readiness summary must consume media release-control evidence.");
requireText(readinessSummary, "Media release-control evidence", "Pilot readiness summary must expose media release-control evidence.");
requireText(classroomLaunchGate, "mediaReleaseControlBinding", "Classroom launch gate must consume media release-control evidence.");
requireText(classroomLaunchGate, "media-release-control", "Classroom launch gate must expose the media release-control source.");
