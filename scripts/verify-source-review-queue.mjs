...
requireText(sourceWorkspacePanel, "Teacher source review workspace", "Source review workspace panel must expose its heading.");
requireText(sourceWorkspacePanel, "Review-only source intake", "Source review workspace panel must expose review-only intake.");
...
requireText(routeContracts, "/teacher/sources/[tenantId]", "Route contracts must register the teacher source review workspace.");
requireText(partnerDemo, "Teacher source review workspace", "Partner demo must link to the teacher source review workspace.");
