...
const markers = [
  ...
  ["model", "verificationReferenceAt"],
  ["model", "WhiteLabelReleaseBrowserEvidenceMode"],
  ["model", "WHITE_LABEL_RELEASE_EVIDENCE_FRESHNESS_WINDOW_MS"],
  ["model", "validateWhiteLabelReleaseReadinessFreshness"],
  ...
  ["model", "storageSelectionPreflightId"],
  ["model", "storageSelectionGateId"],
  ["model", "storage selection must remain blocked"],
  ["model", "storage selection must remain disallowed"],
  ["model", "WhiteLabelReleaseQualityEvidence"],
  ["model", "WhiteLabelReleaseQualityEvidenceKind"],
  ...
  ["model", "pilot evidence blockers must be unique"],
  ["model", "pilot evidence blockers must contain only non-empty strings"],
  ...
  ["sample", "2026-09-23T00:00:00.000Z"],
  ["sample", 'browserEvidenceMode: "coded-rehearsal"'],
  ...
  ["sample", "storageSelectionPreflightId: samplePilotReviewDecision.storageSelectionPreflightId"],
  ["sample", "storageSelectionGateId: samplePilotReviewDecision.storageSelectionGateId"],
  ["sample", "browser-rehearsal-evidence"],
  ["sample", "privacy-negative-test"],
  ["sample", "tenant-negative-test"],
  ...
  ["panel", "Evidence as of"],
  ["panel", "Browser evidence"],
  ["panel", "Evidence freshness"],
  ["panel", "Evidence checks are separate from approval"],
  ["panel", "Evidence tenant"],
  ["panel", "Evidence package"],
  ["panel", "Pilot tenant scope"],
  ["panel", "Pilot package scope"],
  ["panel", "Package evidence tenant"],
  ["panel", "Package evidence scope"],
  ["panel", "Control evidence tenant"],
  ["panel", "Control evidence scope"],
