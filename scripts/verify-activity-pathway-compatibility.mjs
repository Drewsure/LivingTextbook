...
const failures = [];
const requiredOfferedItems = ["entry-flashcards", "match-up", "label-it", "memory-match", "teacher-review-quiz", "true-false", "type-answer", "spelling-practice", "sentence-builder"];
