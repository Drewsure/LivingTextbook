...
for (const marker of [
  ...
  "must be a string",
  "must be a bounded safe identity",
  "feature must be a supported entitlement feature",
  "requestedState must be a supported entitlement state",
  "mode must be a supported entitlement runtime mode",
  "packageTier must be a supported entitlement tier",
  "must be a boolean",
