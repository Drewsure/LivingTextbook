...
for (const fragment of [
  ...
  "Canonical game event ${event.type} must use a bounded safe unit identity.",
  "Canonical game event ${event.type} must use a bounded safe launch identity.",
  "Canonical game event ${event.type} must use a bounded safe student session identity.",
  "must preserve unit",
