...
requireFragments("status route", statusRoute, ["getConfiguredPersistenceProvider", "getPersistenceDeploymentGateSnapshot", "derivePersistenceReadiness", "effectiveStatus"]);
