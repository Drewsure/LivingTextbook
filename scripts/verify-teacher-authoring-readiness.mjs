...
requireText(draftData, "AI-generated daily routines draft preview", "Teacher draft package data must include AI-generated draft preview.");
requireText(draftData, "Requires AI verifier submission packet before teacher approval.", "AI-generated draft must require verifier packet before approval.");
requireText(draftData, "Generated content cannot create routes, playlists, assignments, or local bundles.", "AI-generated draft must block direct route, playlist, assignment, and local-bundle creation.");
requireText(draftData, "Assign generated draft to students", "AI-generated draft must block direct student assignment.");
requireText(draftData, "Create route from AI draft", "AI-generated draft must block route creation.");
requireText(draftData, "Create playlist from AI draft", "AI-generated draft must block playlist creation.");
...
requireText(reviewQueue, "queue-ai-draft-sample-publisher-l1-routines-v1", "Teacher draft review queue must include the AI-generated draft queue item.");
requireText(reviewQueue, "AI verifier submission packet", "AI draft review queue item must include AI verifier submission packet.");
requireText(reviewQueue, "AI verifier submission packet required", "AI draft review queue item must require verifier packet.");
requireText(reviewQueue, "AI draft queued for review", "AI draft review queue item must show AI draft audit event.");
requireText(reviewQueue, "AI verifier packet reviewed", "AI draft review queue item must show AI verifier packet audit event.");
requireText(reviewQueue, "AI draft returned or rejected", "AI draft review queue item must show AI decision audit event.");
requireText(reviewQueue, "AI schema packet ready", "AI draft review queue item must show AI schema preflight.");
requireText(reviewQueue, "AI audio coverage pending", "AI draft review queue item must show AI audio preflight blocking.");
requireText(reviewQueue, "AI engine binding ready", "AI draft review queue item must show AI engine preflight.");
...
requireText(reviewQueuePanel, "Source lineage", "Teacher draft review queue panel must expose source lineage.");
