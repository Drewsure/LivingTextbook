...
- AI prototype patch change set previews preserve linked work order, planned file changes, invariant checks, review blockers, next required records, route safety, rollback, storage verification, reviewer identity, and blocked actions before any apply-patch action, generated file write, or app patch work can exist.
...
- Patch change set preview records preserve planned file changes, invariant checks, review blockers, next records, and change-set blockers before apply-patch actions, generated file writes, tests, routes, scoring, rewards, audio manifests, packages, assignments, or support-language progress can exist.
