...
- Confirm `npm run verify:launch-safety` passes after launch, front-door, private assignment, teacher session monitor, report package, or classroom launch gate changes.
