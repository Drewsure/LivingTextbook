...
| `/collection/[code]` | Student | Active scaffold | Deterministic mastery-earned collection room preview for avatar, room, companion, cosmetic, title, badge, and power-up unlocks. |
