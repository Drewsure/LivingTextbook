...
| Switch template | Use curated activity pathways and compatibility rules, not an unrestricted switch-anything panel. | Planned | Each unit should expose teacher-approved offers such as flashcards, Match Up, Label It, Memory Match, quiz, sentence builder, Speak It, printables, or premium arcade modes. |
