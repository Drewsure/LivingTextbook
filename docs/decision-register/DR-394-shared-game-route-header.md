...
The active game routes now include Flashcards, Match Up, Memory Match, Balloon Pop, Quiz, True or False, Type Answer, Sentence Builder, and Speak It. These routes should feel consistent while the platform remains structurally clean and white-labelable.
