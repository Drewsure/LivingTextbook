...
The platform should help teachers and students navigate a curated pathway: launch, flashcards, Match Up, Label It, Memory Match, Balloon Pop, Quiz, Type Answer, Sentence Builder, Speak It, Training Academy, media, and print. That is different from promising that any teacher content can instantly become any activity.
...
- The active route count is now 71 checked routes after dedicated Match Up, Label It, Balloon Pop, True or False, and Type Answer activity routes.
