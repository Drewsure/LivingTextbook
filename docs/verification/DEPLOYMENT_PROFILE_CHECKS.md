...
9. Confirm no route or label implies that a raw PDF, AI draft, or unreviewed package can be assigned directly to students.
10. Confirm the route contract for `/teacher/intake` includes `TenantDeploymentProfile[]`.
...
- No real offline bundle manifest is loaded yet.
