...
- The teacher intake route confirms evidence attachment storage readiness, including hosted object storage, closed local evidence folder, hybrid export archive, quarantine/checksum/malware/retention/delete-policy metadata, and blocked upload/write/download/signature/release/student-facing behavior.
