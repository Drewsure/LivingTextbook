...
- Playable routes confirm activity shell text for Training Academy, Quiz, True or False, Sentence Builder, and Speak It, including tenant-specific themes where needed.
