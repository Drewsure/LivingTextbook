...
- The route includes demo media controls for start, pause, and completion telemetry.
...
- Demo media controls state that they do not write production reports, unlock games, or award mastery.
