# Active Route Matrix 27-Route Checks

Run after active route, game route, media route, teacher report, local companion, QR, or route verification changes.
...
- The active route matrix shows `27 checked routes`.
