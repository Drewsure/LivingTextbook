...
- The active route matrix shows `69 checked routes`.
...
- The matrix includes flashcards, Match Up, memory, Balloon Pop, quiz, True or False, Type Answer, sentence, speak, media, teacher session, and Training Academy routes for both tenant samples.
- `verify:game-modes` requires active Flashcards, Match Up, Memory Match, Balloon Pop, Quiz, True or False, Type Answer, Sentence Builder, and Speak It routes to have route contract ids, patterns, and helper functions.
