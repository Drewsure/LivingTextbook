...
- The active route matrix shows `63 checked routes`.
...
- The matrix includes flashcards, memory, Balloon Pop, quiz, sentence, speak, media, teacher session, and Training Academy routes for both tenant samples.
- `verify:game-modes` requires active Flashcards, Memory Match, Balloon Pop, Quiz, Sentence Builder, and Speak It routes to have route contract ids, patterns, and helper functions.
