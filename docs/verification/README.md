...
- `docs/verification/PACKAGE_ENTITLEMENT_VERIFIER_CHECKS.md`
...
- `docs/verification/PACKAGE_READINESS_VERIFIER_CHECKS.md`
...
- `docs/verification/PERSISTENCE_READINESS_ROUTE_CHECKS.md`
...
- `docs/verification/PRIVATE_ASSIGNMENT_LINK_ROUTE_CHECKS.md`
...
- `docs/verification/TEACHER_REPORTING_READINESS_ROUTE_CHECKS.md`
...
- `docs/verification/TEACHER_SESSION_SETTINGS_WORKBENCH_ROUTE_CHECKS.md`
...
- `docs/verification/ROUTE_GRADUATION_GATE_CHECKS.md`
...
Returned package checklist alignment is verified by `npm run verify:prototype-review`
...
- `PERSISTENCE_SERVER_POLICY_BOUNDARY_CHECKS.md` protects server-owned
  persistence approval and browser intent separation.
- Run `npm run verify:runtime-behavior` and `npm run verify:backend-storage`.
- `PERSISTENCE_READ_AUTHORIZATION_CHECKS.md` protects explicit read purpose,
  matching learner-session authorization, and tenant-scoped teacher probes.
